window.TRIP_DATA = {
  ...
  days: [
    ...
    day(6, "08.25", "Tue", "Montserrat · Optional Rooftop", "Mountain day", "FGC R5와 Aeri de Montserrat Cable Car로 수도원에 올라가 Sant Joan 전망을 보는 날입니다. 저녁에는 숙소 근처에서 회복하고, 컨디션이 좋을 때만 접근성 좋은 루프탑으로 야경을 짧게 봅니다.", [
      ...
      stop("09:30", "Aeri de Montserrat Cable Car", "Aeri de Montserrat Cable Car", "montserrat", "cablecar", guide("Aeri de Montserrat Cable Car는 산 아래 역에서 수도원까지 약 5분 만에 올라가는 가장 인상적인 접근 방식입니다.", "케이블카가 절벽과 계곡 위를 지나며 Montserrat 산세가 바로 가까워지므로, 창가 쪽에서 짧게 풍경을 보고 휴대폰은 손에서 놓치지 않게 잡습니다."), "https://aeridemontserrat.com/en/"),
      ...
      stop("16:10", "Aeri de Montserrat Station", "Aeri de Montserrat Station", "montserrat", "cablecar", guide("케이블카 하부역에서 FGC R5로 다시 연결하는 구간입니다.", "Barcelona 방향 열차 플랫폼과 다음 출발 시간을 확인하고, 물을 보충한 뒤 무리 없이 돌아갑니다.")),
