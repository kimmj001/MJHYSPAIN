window.TRIP_DATA = {
  ...
  days: [
    ...
    day(6, "08.25", "Tue", "Montserrat · Optional Rooftop", "Mountain day", "FGC R5와 Aeri de Montserrat Cable Car로 수도원에 올라가 Sant Joan 전망을 보는 날입니다. 저녁에는 숙소 근처에서 회복하고, 컨디션이 좋을 때만 접근성 좋은 루프탑으로 야경을 짧게 봅니다.", [
      ...
      stop("16:00", "Aeri de Montserrat Cable Car 하산", "Aeri de Montserrat Cable Car", "montserrat", "walking", guide("Montserrat에서 Aeri de Montserrat Cable Car를 타고 산 아래 역으로 내려갑니다.", "하산도 약 5분이지만 대기 줄이 생길 수 있으므로, FGC R5 시간에 너무 딱 맞추지 않고 여유 있게 내려가는 편이 좋습니다."), "https://aeridemontserrat.com/en/"),
      stop("16:10", "Aeri de Montserrat Station", "Aeri de Montserrat Station", "montserrat", "transit", guide("케이블카 하부역에서 FGC R5로 다시 연결하는 구간입니다.", "Barcelona 방향 열차 플랫폼과 다음 출발 시간을 확인하고, 물을 보충한 뒤 무리 없이 돌아갑니다.")),
      stop("16:20", "FGC R5 Barcelona 방향", "Aeri de Montserrat Station", "montserrat", "transit", guide("Aeri de Montserrat Station에서 FGC R5를 타고 Plaça d'Espanya로 돌아갑니다.", "산에서 내려온 뒤 피로가 크게 올 수 있으니 열차 안에서는 쉬고, 저녁 욕심은 줄이는 흐름으로 생각합니다.")),
