window.TRIP_DATA = {
  ...
  days: [
    ...
    day(3, "08.22", "Sat", "Sant Antoni · Barceloneta · Sants", "Sea and festival", "낮에는 바다, 밤에는 Sants 축제입니다. 해변과 식사를 분리해 너무 오래 땡볕 아래 있지 않게 합니다.", [
      ...
      meal("21:00", "저녁 식사", "Carrer de Valladolid · Sants 식당가", "Carrer de Valladolid, Sants, Barcelona", "walking", "Festa Major de Sants 주변에서 가볍게 선택"),
    ...
    day(4, "08.23", "Sun", "Sitges Festa Major", "Trip highlight", "이번 여행의 하이라이트입니다. 낮부터 Sitges에 들어가 구시가지, 교회, 해변, La Fragata, 23시 불꽃까지 이어갑니다.", [
      ...
      meal("15:00", "점심 식사", "El Cable", "El Cable, Carrer Barcelona, 1, Sitges", "walking", "Bomba, Pintxos"),
      ...
      stop("23:45", "택시로 숙소 이동", "La Fragata Sitges", "sitgesWait", "taxi", guide("불꽃이 끝나면 택시로 바로 숙소 방향으로 이동합니다.", "La Fragata 바로 앞은 인파와 통제가 있을 수 있으니 큰길 쪽으로 조금 빠져나와 택시 호출이 잡히는 지점을 기준으로 움직이고, 둘이 떨어지지 않는 것이 우선입니다.")),
      stop("00:50", "숙소 복귀", "Urgell Barcelona", "lodging", "taxi", guide("Sitges 하이라이트를 끝내고 바로 쉬는 귀가 구간입니다.", "숙소에 도착하면 씻고 바로 쉬며, 다음 날은 회복형 도심 산책이라 늦은 아침까지 무리하지 않아도 됩니다."))
    ]),
    day(5, "08.24", "Mon", "Gothic Quarter · El Born · Sants", "Recovery city walk", "Sitges 다음 날이라 천천히 시작합니다. Gothic과 Born은 유지하되 중간에 무리한 실내 관람을 넣지 않고, 골목과 성당 중심으로 회복감 있게 걷습니다.", [
    ...
    day(8, "08.27", "Thu", "Girona Day Trip", "Medieval photo day", "고속열차로 Girona를 다녀오는 날입니다. 성벽 산책까지 있어 걷는 양이 많습니다.", [
      ...
      stop("10:00", "Pont de les Peixateries Velles", "Pont de les Peixateries Velles Girona", "girona", "walking", guide("Pont de les Peixateries Velles는 Eiffel 회사가 만든 붉은 철교로, Girona 구시가지와 Onyar 강변 컬러 하우스를 가장 선명하게 연결해주는 첫 장면입니다.", "19세기 철 구조물이 중세 도시 풍경 안에 들어온 대비가 좋아, 다리 자체와 강변 집들을 함께 보면 Girona의 오래된 층과 근대적 감각이 동시에 보입니다.", "다리 위에서 오래 멈추기보다 양쪽 강변을 번갈아 보며 사진을 짧게 남기면 동선이 매끄럽습니다.")),
      stop("10:45", "Girona Old Town", "Girona Old Town", "girona", "walking", guide("Girona Old Town은 로마 시대 Gerunda에서 시작해 중세 성벽, 유대인 지구 Call, 대성당 주변 언덕길이 겹쳐 남은 역사 도시입니다.", "좁은 골목과 계단이 많은 이유도 방어와 종교, 생활 공간이 오랜 시간 한 언덕에 쌓였기 때문이라, 천천히 올라갈수록 도시의 깊이가 더 잘 느껴집니다.", "골목 분위기와 작은 광장을 보며 Cathedral 방향으로 자연스럽게 이어갑니다.")),
      stop("11:45", "Girona Cathedral", "Girona Cathedral", "girona", "walking", guide("Girona Cathedral은 Romanesque 회랑과 탑, Gothic 본당, Baroque 파사드가 한 건물 안에 겹친 Girona의 가장 상징적인 성당입니다.", "특히 넓은 Gothic 본당과 대계단이 유명해, 외부에서는 도시를 압도하는 무대처럼 보이고 내부에서는 긴 시간에 걸쳐 쌓인 양식의 변화가 느껴집니다.", "내부 관람은 시간과 체력에 맞춰 결정하고, 외부 계단에서는 아래쪽 광장과 함께 보는 구도가 좋습니다."), "https://www.catedraldegirona.cat/"),
      meal("13:15", "점심 식사", "Rambla de la Llibertat 식당가", "Rambla de la Llibertat, Girona", "walking", "Girona 구시가지 중심 식당가에서 현장 선택"),
      stop("15:15", "Passeig de la Muralla", "Passeig de la Muralla Girona", "girona", "walking", guide("Passeig de la Muralla는 Girona를 지키던 옛 성벽 위를 걸으며 구시가지와 주변 산세를 내려다보는 산책로입니다.", "로마와 중세 방어선이 도시의 형태를 어떻게 만들었는지 눈으로 확인할 수 있어, 아래 골목을 걸은 뒤 올라오면 Girona가 입체적으로 정리됩니다.", "그늘이 적고 계단이 있으니 컨디션이 좋을 때만 길게 걷고, 힘들면 일부 구간만 보고 내려와도 충분합니다.")),
